      ...
      : ///SERVER///
        {
          ...
          "Hover Tank": new (function() {
            ...
            c[0].damage = 3.3;
            c[0].speed = 0.31;
            c[1].offdir = -Math.PI - 0.4;
            c[1].offx = -5;
            c[1].offTime = 0.5;
            c[2].offdir = -Math.PI + 0.4;
            c[2].offx = 5;
            c[2].offTime = 0.5;
            ///
            this.canons = c;
          ...
          "Triple Twin": new (function() {
            ...
            c[1].offTime = c[3].offTime = c[5].offTime = 0.5;
          ...
          "Octo Shot": new (function() {
            ...
            c[1].offdir = (Math.PI * 1) / 4;
            c[1].offTime = 0.5;
            c[2].offdir = (Math.PI * 2) / 4;
            c[3].offdir = (Math.PI * 3) / 4;
            c[3].offTime = 0.5;
            c[4].offdir = Math.PI;
            c[5].offdir = (Math.PI * 5) / 4;
            c[5].offTime = 0.5;
            c[6].offdir = (Math.PI * 6) / 4;
            c[7].offdir = (Math.PI * 7) / 4;
            c[7].offTime = 0.5;
            this.canons = c;
          })(),
          Cyclone: new (function() {
            ...
            this.canons[1].offdir = Math.PI * 0.2;
            this.canons[1].offTime = 0.5;
            this.canons[2].offdir = Math.PI * 0.4;
            this.canons[2].offTime = 0;
            this.canons[3].offdir = Math.PI * 0.6;
            this.canons[3].offTime = 0.5;
            this.canons[4].offdir = Math.PI * 0.8;
            this.canons[4].offTime = 0;
            this.canons[5].offdir = Math.PI * 1;
            this.canons[5].offTime = 0.5;
            this.canons[6].offdir = Math.PI * 1.2;
            this.canons[6].offTime = 0;
            this.canons[7].offdir = Math.PI * 1.4;
            this.canons[7].offTime = 0.5;
            this.canons[8].offdir = Math.PI * 1.6;
            this.canons[8].offTime = 0;
            this.canons[9].offdir = Math.PI * 1.8;
            this.canons[9].offTime = 0.5;
          })(),
          Booster: new (function() {
            ...
            c[0].damage = 3.3;
            c[0].speed = 0.32;
            c[1].offdir = -Math.PI - 0.65;
            c[1].offx = -6;
            c[2].offdir = -Math.PI + 0.65;
            c[2].offx = 6;
            c[3].offdir = -Math.PI - 0.35;
            c[3].offx = -5;
            c[3].height = 58;
            c[3].offTime = 0.5;
            c[4].offdir = -Math.PI + 0.35;
            c[4].offx = 5;
            c[4].height = 58;
            c[4].offTime = 0.5;
            ///
          ...
          Raptor: new (function() {
            ...
            c[1].damage = 3.2;
            c[1].speed = 0.3;
            c[2].offdir = Math.PI / 2;
            c[2].offx = -1;
            c[2].pene = 1.4;
            c[2].damage = 3.2;
            c[2].speed = 0.3;
            c[3].offdir = -Math.PI - 0.4;
            c[1].offx = -5;
            c[3].offTime = 0.5;
            c[3].height = 59;
            c[4].offdir = -Math.PI + 0.4;
            c[2].offx = 5;
            c[4].offTime = 0.5;
            c[4].height = 59;
          ...
          Fortress: new (function() {
            ...
            c[4].offdir = (Math.PI * 2) / 3 + Math.PI / 3;
            c[5].offdir = (Math.PI * 4) / 3 + Math.PI / 3;
            this.canons = c;
          })(),
