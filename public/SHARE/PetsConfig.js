  ...
  exports.pets = [
    (ctx, param, CONST, C) => {
      ...
      ctx.arc(
        0,
        0,
        (14 * param.size) / CONST.SIZE + CONST.LINEWIDTH / 2,
        0,
        Math.PI * 2,
        0
      );
    ...
    (ctx, param, CONST, C) => {
      ...
      ctx.beginPath();
      let spike = 18,
        inner = (18 * param.size) / CONST.SIZE,
        outer = (23 * param.size) / CONST.SIZE;
      ...
      ctx.arc(
        0,
        0,
        (15 * param.size) / CONST.SIZE + CONST.LINEWIDTH / 2,
        0,
        Math.PI * 2,
        0
      );
    ...
    (ctx, param, CONST, C) => {
      ...
      ctx.arc(
        0,
        0,
        (18 * param.size) / CONST.SIZE + CONST.LINEWIDTH / 2,
        0,
        Math.PI * 2,
        0
      );
